    ...
    public function store(Request $request)
{
    $validated = $request->validate([
        ...
        'maintenance_cost'  => 'nullable|numeric|min:0', // ✅ optional now
        'installation_fee'  => 'nullable|numeric|min:0', // ✅ optional now
    ]);
    ...
    // 🔹 Compute water consumption charges
    ...
    // 🔹 Fetch unpaid/partial payments before this billing date
    ...
    foreach ($pastPayments as $payment) {
        ...
        if ($unpaidAmount > 0) {
            ...
            if ($billingDate->gt($dueDate)) {
                ...
                $penalty += round($unpaidAmount * 0.005 * $daysLate, 2);
            }
        }
    }

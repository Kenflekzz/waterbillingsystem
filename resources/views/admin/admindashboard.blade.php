...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Water Billing System</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item"><a class="navlink" href="#">Home</a></li>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                           <div class="text-center py-3">
                            <img src="{{ asset('images/water-surface.webp') }}" alt="Logo" style="width: 225px; height: 75px; margin-top: -20px"  />
                           </div>
                           ...
                           <a class="nav-link " href="{{url('admin/payments')}}">
                            <div class="sb-nav-link-icon"><i class="fas fa-credit-card "></i></div> <!-- Payment -->
                            Payment
                        </a>

                        <a class="nav-link " href="{{url('admin/billings')}}" >
                            <div class="sb-nav-link-icon"><i class="fas fa-file-invoice-dollar"></i></div> <!-- Billing -->
                            Billing
                        </a>
                        ...
                        <a class="nav-link" href="{{url('admin/reports')}}">
                            <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div> <!-- Reports -->
                            Reports
                        </a>

                        <a class="nav-link" href="{{url('admin/admins')}}">
                            <div class="sb-nav-link-icon"><i class="fas fa-user-cog"></i></div> <!-- Admins -->
                            Admin/s
                        </a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Magallanes Water Billing System</div>
                            <div>
